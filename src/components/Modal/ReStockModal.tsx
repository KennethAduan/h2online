    ...
    >
      ...
      {isTimer ? 
       ...
       <div className="flex justify-center items-center py-2">
          <button onClick={() => setResetFlag(!resetFlag)} id="reset-btn" className="cursor-pointer inline-flex items-center rounded-full px-9 py-3 text-xl font-mono font-semibold text-[#014762] hover:text-white border-2 border-rose-600
hover:bg-[#014762] transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-75 hover:bg-[#014762] duration-300  focus:bg-transparent">
  RESET
</button>
